...
run (Day d) part = do
  ...
  case d of
    ...
    11 -> print $ chooseSolver D11.solveP1 D11.solveP2 part input
    12 -> print $ chooseSolver D12.solveP1 D12.solveP2 part input
    18 -> print $ chooseSolver D18.solveP1 D18.solveP2 part input
